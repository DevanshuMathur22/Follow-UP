  ...
  return (
    <div>
      <div className="flex flex-col gap-4 border-b border-slate-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Previous prescriptions are shown latest first.
          </p>
          ...
          {doctorMode &&
            ...
            !showBuilder && (
              <p className="mt-1 text-xs font-medium text-indigo-600">
                Latest doctor prescription is available as reference for the new prescription.
              </p>
            )}
        </div>
      ...
      {!showBuilder && (
        <div className="mt-5">
          {records.length ? (
            <div className="max-h-[520px] divide-y divide-slate-100 overflow-y-auto rounded-xl border border-slate-200">
              {records.map((item, index) => (
                <div
                  key={item.id}
                  className={`flex flex-col gap-3 px-4 py-3.5 transition sm:flex-row sm:items-center sm:justify-between ${
                    index === 0
                      ? "bg-indigo-50/40"
                ...
                >
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {index === 0 && (
                        <span className="rounded-md bg-indigo-100 px-2 py-1 text-[10px] font-semibold uppercase tracking-wide text-indigo-700">
                          Latest
                        </span>
                      )}
                    </div>
